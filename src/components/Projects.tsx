        ...
        return <Card key={project.id} className="hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <CardContent className="pt-0">
                ...
                <div className="flex items-center justify-between mt-4 pt-4 border-t">
                  <Button variant="outline" size="sm" onClick={() => navigate(`/projects/${project.id}`)} className="w-full bg-purple-600 hover:bg-purple-700 text-white hover:text-white font-medium">
                    Open Project
                  </Button>
