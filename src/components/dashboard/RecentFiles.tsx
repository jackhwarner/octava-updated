...
// The entire RecentFiles export is commented out to "fully hide" the section per user request, but code is retained for easy restoration
...
// The RecentFiles section is hidden. Restore export if you want it back.
