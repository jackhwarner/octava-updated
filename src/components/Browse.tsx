...
const Browse = () => {
  ...
  return <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="max-w-6xl mx-auto">
        <BrowseFilters selectedRole={selectedRole} setSelectedRole={setSelectedRole} selectedGenre={selectedGenre} setSelectedGenre={setSelectedGenre} selectedInstrument={selectedInstrument} setSelectedInstrument={setSelectedInstrument} selectedExperience={selectedExperience} setSelectedExperience={setSelectedExperience} location={location} setLocation={setLocation} onSearch={handleSearch} />

        {hasSearched ? <SearchResults profiles={collaboratorsFormatted} /> : <div className="space-y-10">
