      ...
      <div className="w-[90px] bg-white border-r border-gray-200 flex flex-col items-center py-3 h-full">
        ...
        <div className="mb-3">
          <DropdownMenu open={isNotificationsOpen} onOpenChange={setIsNotificationsOpen}>
            ...
            <DropdownMenuContent align="end" className="w-80 p-3 mr-32">
              ...
              <DropdownMenuSeparator />
              <button 
                className="w-full text-center text-sm text-purple-600 py-2"
        ...
        <div className="mt-auto mb-3">
          <DropdownMenu open={isUserMenuOpen} onOpenChange={setIsUserMenuOpen}>
            <DropdownMenuTrigger asChild>
              <button 
                className="w-11 h-11 bg-gray-300 rounded-full flex items-center justify-center hover:ring-2 hover:ring-purple-300 transition-all"
